            ...
            <div className="pt-4 mb-5">
              ...
              <div className="mb-4">
                ...
                <p>
                  ...
                  you receive badges for being especially helpful. Badges appear
                  on your profile page, questions & answers.
                </p>
              </div>
                  ...
                  <div className="col-10 main p-3">
                    <div className="row">
                      <div className="col-3 col3">
                        ...
                        <span>
                          <BsCcCircle
                            style={{ color: bronzeColor, fontSize: "35px" }}
                          />
                      ...
                      <div className="col-9">
                        <p className="m-0">
                          You must have a total score of 0 in at least 10
                          non-community wiki answers to achieve this badge.
                          Highest scoring answer that outscored an accepted
                  ...
                  <div className="col-10 main p-3">
                    <div className="row">
                      <div className="col-3 col3">
                        ...
                        <span>
                          <BsCcCircle
                            style={{ color: silverColor, fontSize: "35px" }}
                          />
                      ...
                      <div className="col-9">
                        <p className="m-0">
                          You must have a total score of 50 in at least 50
                          non-community wiki answers to achieve this badge.
                          Highest scoring answer that outscored an accepted
                          answer with score of more than 50.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-10 main p-3">
                    <div className="row">
                      <div className="col-3 col3">
                        ...
                        <span>
                          <BsCcCircle
                            style={{ color: goldenColor, fontSize: "35px" }}
                          />
                      ...
                      <div className="col-9">
                        <p className="m-0">
                          You must have a total score of 100 in at least 100
                          non-community wiki answers to achieve this badge.
                          Highest scoring answer that outscored an accepted
                          answer with score of more than 100.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="row">
                  ...
                  <div className="col-10 main p-3">
                    <div className="row">
                      <div className="col-3 col3">
                        <p className="bgcs bg-success text-center text-white">
                          <span style={{ fontSize: "small" }}>
                            Master of Scuttlebutt
                          </span>
                        </p>
                        <span>
                          <GiDiamonds
                            style={{ color: gradientStyle, fontSize: "35px" }}
                          />
                      ...
                      <div className="col-9">
                        <p className="pt-3">
                          You must have a total score of 250 in at least 150
                          non-community wiki answers to achieve this badge.
                          Highest scoring answer that outscored an accepted
                          answer with score of more than 150.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="row">
                  ...
                  <div className="col-10 main p-3">
                    <div className="row">
                      ...
                      <div className="col-9">
                        <p className="m-0">
                          You must have a total score of 500 in at least 200
                          non-community wiki answers to achieve this badge.
                          Highest scoring answer that outscored an accepted
                          answer with score of more than 200.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="row">
                  ...
                  <div className="col-10 main p-3">
                    <div className="row">
                      ...
                      <div className="col-9">
                        <p className="m-0">
                          You must have a total score of 1000 in at least 250
                          non-community wiki answers to achieve this badge.
                          Highest scoring answer that outscored an accepted
                          answer with score of more than 250.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="row">
                  ...
                  <div className="col-10 main p-3">
                    <div className="row">
                      ...
                      <div className="col-9">
                        <p className="m-0">
                          You must have a total score of 5000 in at least 100
                          non-community wiki answers to achieve this badge.
                          Highest scoring answer that outscored an accepted
                          answer with score of more than 100.
                        </p>

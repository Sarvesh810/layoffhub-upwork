                ...
                <div className="row">
                  <div className="col-3 ">
                    <h4 className="tags pt-2">
                      <MdHelp className="text-primary" size={30} />
                      Help
                    </h4>
                  </div>
                </div>
                  ...
                  <div className="row">
                    <div className="col-12">
                      <p className="mx-5 pt-2">
                        Find out everything you need to get started by taking
                        the tour. If you still have questions, come back and
                        check out the pinned articles, if you still need help
                        contact us: admin@layoffhub.ai
                      </p>
                    </div>
                  </div>
                </div>

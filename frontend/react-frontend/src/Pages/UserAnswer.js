...
const UserAnswer = () => {
  ...
  const getQuestions = async () => {
    const url = `${API_BASE_URL}/api/user/${user_id}/questions_answers/`;
    try {
      ...
      <div className="col-lg-12 d-flex flex-row user-question-container">
        ...
        <div className="main-content1 col-8 mx-4">
                    ...
                    <div className="card-body">
                      ...
                      <div className="d-flex justify-content-start bg-warning bgbb p-3">
                        <h4 className="card-text">
                          <span className="fs-6">Your Reply:</span>{" "}
                          {item.caption}
                        </h4>
                      </div>
                    </div>
          ...
          {answers.length > visibleCount && (
            <button className="btn btn-primary" onClick={showMoreQuestions}>
              All Replies
            </button>
          )}
        </div>

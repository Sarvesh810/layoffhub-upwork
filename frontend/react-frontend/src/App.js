    ...
    <>
      <Router>
        <Routes>
          ...
          <Route path="/termandconditions" element={<TermsCondition />} />
          {/* done */}
          <Route path="/help" element={<Help />} />
          <Route path="/slider" element={<Slide1 />} />
          <Route path="/recentquestion" element={<RecentQuestion />} />
          <Route path="/bumpquestion" element={<BumpQuestion />} />
          {/* done */}
          ...
          {/* done */}
          <Route path="/ans" element={<UserAnswer />} />
          {/* done */}
          ...
          {/* done */}
          <Route path="/postgroup" element={<GroupPosts />} />
          {/* done */}
          <Route path="/givenanswer" element={<AnswersGiven />} />
          {/* done */}

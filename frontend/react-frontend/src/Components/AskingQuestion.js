                    ...
                    <div className="pt-4">
                        <div className="pb-3">
                            ...
                            <div className="input-group">
                                <input type="file" className="form-control" accept="image/*" id="imageUpload" />
                            </div>
                        </div>
                    </div>
                    <div className="pt-4">
                        <div className="pb-3">
                            <h4>Details</h4>
                            <button className="btn btn-primary"><TbCapture className="mx-1" size={25} /> Add Media</button>
                        </div>
                    </div>
                    <div className="pt-4">
                        <div className="pb-3">
                            ...
                            <textarea ref={textareaRef} className="form-control" rows="4" value={caption} onChange={(e) => setCaption(e.target.value)} />
                        </div>
                    </div>
                    <div className="pt-4">
                        <div className="form-check">
                            <input type="checkbox" className="form-check-input" id="anonymousCheck" checked={anonymous} onChange={() => setAnonymous(!anonymous)} />
                            <label className="form-check-label" htmlFor="anonymousCheck">Post anonymously</label>
                        </div>
                    </div>
                    <div className="pt-4">
                        <button className="btn btn-primary" onClick={ask_a_question}>Submit Question</button>
                    </div>
                </div>
            </div>
        </div>

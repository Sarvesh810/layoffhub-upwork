...
from .views import GroupView, ManageGroupView, GroupPostsCreateAndListView, LogoutView, NotificationListView, UserQuestionsListView, TagListView, CompanyProfileByNameView
...
urlpatterns = [
    ...
    path('user/<int:user_id>/questions_answers/', UserQuestionsAnswersListView.as_view(), name='user_questions_answers'),
    ...
    path('most_answered_questions/', MostAnsweredQuestionsView.as_view(), name='most_answered_questions'),# top 10 companies
